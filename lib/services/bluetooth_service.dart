  ...
  Future<void> _processRealtimeData() async {
    ...
    try {
      ...
      setState(() {
        ...
        _samplesCollected += _realtimeDataBuffer.length;
      });
  ...
  Widget _buildRealtimeDataPanel() {
    return StreamBuilder<List<double>>(
      ...
      builder: (context, snapshot) {
        final eegData = snapshot.data ?? [];
        if (eegData.isNotEmpty) {
          _lastEEGData = eegData;
          _realtimeDataBuffer.add(List.from(eegData));
        }
              ...
              children: [
                ...
                if (_lastEEGData.isNotEmpty) ...[
                  Container(
                    ...
                    child: Row(
                      children: _lastEEGData.asMap().entries.map((entry) {
